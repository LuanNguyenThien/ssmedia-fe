...
const Streams = () => {
    ...
    useEffect(() => {
        ...
        const headerDesktopElement = document.querySelector(
            'div[class="header-navbar grid grid-cols-5"]'
        );
        const headerElement = document.querySelector(
            'div[class="h-[8vh] bg-secondary flex items-center justify-between px-4"]'
        );
        const footerElement = document.querySelector(
            "div.fixed.bottom-0.bg-background.z-50"
        );

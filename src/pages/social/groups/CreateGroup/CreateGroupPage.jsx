...
const CreateGroupPage = () => {
    ...
    const [groupData, setGroupData] = useState({
        ...
        privacy: {
            whoCanJoin: "anyone", // anyone, invite_only, admin_approval
            whoCanPost: "members", // members, admins_only
            whoCanSeeMembers: "members", // everyone, members, admins_only
            whoCanSeePosts: "members", // everyone, members, admins_only
        },
        ...
        // Other Settings
        memberLimit: null, // null = unlimited
        language: "en",
        allowDiscovery: true, // can be found in search
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Object.keys(groupData).forEach((key) => {
                if (key === "privacy" || key === "contentSettings") {
                    ...
                    formData.append(key, JSON.stringify(groupData[key]));
                } else if (key === "profilePicture" || key === "coverImage") {
                    if (groupData[key]) {
            ...
            // Navigate to the new group or groups page
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-white/80 rounded-2xl shadow-sm p-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        {/* Invite Members */}
                        <InviteMembers
                            invitedMembers={groupData.invitedMembers}

        ...
        <div>
            ...
            <div className="space-y-6">
                {notificationTypes.map((data, index) => (
                    ...
                    >
                        <div>
                            <h4 className="font-medium text-base mb-1">{data.title}</h4>
            ...
            <div className="flex justify-end mt-8">
                <Button label="Update" className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" disabled={false} handleClick={sendNotificationSettings} />
            </div>
        </div>
    );
};

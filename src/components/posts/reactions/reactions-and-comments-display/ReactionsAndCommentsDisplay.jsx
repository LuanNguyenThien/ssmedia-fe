...
const ReactionsAndCommentsDisplay = ({ post }) => {
    ...
    const [setSelectedPostReactId] = useLocalStorage(
        "selectedPostReactId",
        "set"
    );
    ...
    const sumAllReactions = (reactions) => {
        ...
        const result = Object.values(reactions).reduce(
            (prev, next) => prev + next,
            0
        );
    ...
    return (
        <div className="reactions-display h-max pt-2" >
                        ...
                        {postCommentNames.length && (
                            <>
                                ...
                                {postCommentNames.length > 20 && (
                                    <span>
                                        and {postCommentNames.length - 20}{" "}
                                        others...
                                    </span>
                                )}
                            </>

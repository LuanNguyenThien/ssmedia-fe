...
class UserService {
    ...
    //[Personalize]
    // {subject: [string]}
    async updatePersonalHobby(hobby) {
        const response = await axios.put(`/user/profile/personal-hobby`, hobby);
        return response;
    }

    async updatePersonalizeSettings(settings) {
        const response = await axios.put(
            "/user/profile/personalize-settings",
            settings
        );
        return response;
    }

    async clearAllPersonalize() {
        const response = await axios.put(
            "/user/profile/personalize-settings/clear"
        );
        return response;
    }

    async clearBehaviorPersonalize() {
        const response = await axios.put(
            `/user/profile/personalize-settings/clear/user-behavior`
        );
        return response;
    }
}

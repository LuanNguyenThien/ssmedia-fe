...
export class Utils {
    ...
    static appImageUrl(version, id) {
        ...
        return `https://res.cloudinary.com/di6ozapw8/image/upload/v${version}/${id}`;
    }
    ...
    static getVideo(videoId, videoVersion) {
        return videoId && videoVersion
            ? `https://res.cloudinary.com/di6ozapw8/video/upload/v${videoVersion}/${videoId}`
            : "";
    }
    ...
    static revertNegativeToPositiveNumber(number) {
